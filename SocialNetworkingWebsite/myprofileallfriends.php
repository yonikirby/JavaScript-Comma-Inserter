...
<div id = "FriendsInnerContainer">
  ...
  border-bottom:3px solid #1F76F2;">All Friends</button>
            		          ...
            		          <!--
            		          <button class = "FriendsButton" type="button">Recently Added</button>
            		          
            		          <button class = "FriendsButton" id = "BirthdaysButton" type="button" onclick="loadFriendsResults(\'Birthdays\')">Birthdays</button>
            		          
            		          <button class = "FriendsButton" type="button">Work</button>
            		          <button class = "FriendsButton" type="button">High School</button>
            		          <button class = "FriendsButton" type="button">Current City</button>
            		          <button class = "FriendsButton" type="button">Hometown</button>
            		          <button class = "FriendsButton" type="button">Following</button>
